export const IconHome = ({ width = '20', height = '20' }) => (
  <svg
    width={width}
    height={height}
    fill='currentColor'
...
export const IconConta = ({ width = '20', height = '20' }) => (
  <svg
    width={width}
    height={height}
    fill='currentColor'
...
export const IconLinks = ({ width = '20', height = '20' }) => (
  <svg
    width={width}
    height={height}
    fill='currentColor'
...
export const IconConfig = ({ width = '20', height = '20' }) => (
  <svg
    width={width}
    height={height}
    fill='currentColor'
